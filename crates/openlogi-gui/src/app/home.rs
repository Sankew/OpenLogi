//! The Home screen: the device gallery, its cards, and the scanning / empty
//! body states.

use std::sync::Arc;

use gpui::{
    AnyElement, BorrowAppContext as _, Bounds, BoxShadow, Context, Div, FontWeight, Hsla,
    InteractiveElement, IntoElement, ParentElement, StatefulInteractiveElement as _, Styled,
...
use super::AppView;
use super::widgets::{
    add_device_button, connection_icon_path, kind_label, loading_body, notice_body,
};
...
/// ([`InventoryHealth::Unavailable`](openlogi_agent_core::ipc::InventoryHealth::Unavailable)):
/// scanning never completed and won't
