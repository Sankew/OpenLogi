...
use detail::{detail_content, detail_header};
use home::{
    device_empty_state, device_gallery, device_scanning_state, home_header,
    scanning_unavailable_state,
};
use widgets::{loading_body, notice_body};
